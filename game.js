 ...
 ****************************************************/
 ...
 function startGame() {
    ...
    spawn = setInterval(spawnEnemy, 1000)
...
function spawnEnemy() {
  ...
  let marginBottomEnnemy =  getRandomArbitrary(100, 500)
  newObstacle.style.bottom = marginBottomEnnemy + "px";
...
let audio = new Audio("audio/musicSonic.mp3")
